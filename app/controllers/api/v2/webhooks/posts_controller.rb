module Api
  module V2
    module Webhooks
      class PostsController < ::Api::V2::BaseController
        skip_before_action :verify_authenticity_token

        resource_description do
          name 'API v2 - Webhooks - Posts'
          short 'Incoming webhook to create posts (v2)'
          api_versions 'v2'
        end

        api :POST, '/api/v2/webhooks/posts', 'Create a post via incoming webhook (v2)'
